# -*- coding: utf-8 -*-
"""
Created on Mon Jun 29 15:53:52 2020
...
def about():
    ...
    lbla = Label(p, font=('aria', 15, 'bold'),text="In this project I have created an analysis of certain sectors that form a part of the NSE 50 index on the basis of stock prices.\nWith help of this project an investor can get an idea of the variation of the stock prices with each year\n1.The graphs show us the volatality of the share during a period.\n2.It helps us intaking advantage of dips and rise in prices and invest in fundamentally sound companies.\n3.By hovering the mouse over the graph one can get the price and the year on y axis and x axis respectively ",fg="green", bg='black', bd=5)
...
#BUTTONS
    ...
    btn1=Button(f1,padx=70,pady=8, bd=10 ,fg="green",font=('ariel',14,'bold'),width=16, text="AUTOMOBILE COMPANIES",bg="black", command=automobilecompanies)
    ...
    btn4=Button(f1,padx=70,pady=8, bd=10 ,fg="green",font=('ariel',14,'bold'),width=16, text="ENERGY SECTOR",bg='black', command=energysectorcompanies)
